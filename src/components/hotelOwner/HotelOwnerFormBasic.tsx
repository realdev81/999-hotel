          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div className="space-y-8">
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-3">
                  <p className="text-sm text-black">
                    {t("hotelOwner.imagesDescription")}
                  </p>
                    ...
                    <div className="space-y-2 text-sm">
                      <div className="flex justify-start gap-3">
                        ...
                        <span className="text-left">
                          {t("hotelOwner.numberOfImagesValue")}
                        </span>
                      </div>
                      <div className="flex justify-start gap-3">
                        <div className="w-[95px] sm:w-[130px] flex justify-end">
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-3">
                  <p className="text-sm text-black">
                    {t("hotelOwner.websiteImagesDescription")}
                  </p>
                  ...
                  <div className="border border-gray-300 rounded-lg p-4 bg-[#FFFAFA]">
                    ...
                    <div className="space-y-2 text-sm">
                      <div className="flex justify-start gap-3">
                        ...
                        <span className="text-left">
                          {t("hotelOwner.websiteNumberOfImagesValue")}
                        </span>
                      </div>
                      <div className="flex justify-start gap-3">
                        <div className="w-[95px] sm:w-[130px] flex justify-end">
                        ...
                        <span className="text-left">
                          {t("hotelOwner.websiteFormatValue")}
                        </span>
                      </div>
                      <div className="flex justify-start gap-3">
                        <div className="w-[95px] sm:w-[130px] flex justify-end">
                        ...
                        <span className="text-left">
                          {t("hotelOwner.websiteColorModeValue")}
                        </span>
                      </div>
                      <div className="flex justify-start gap-3">
                        <div className="w-[95px] sm:w-[130px] flex justify-end">
                        ...
                        <span className="text-left">
                          {t("hotelOwner.websiteResolutionValue")}
                        </span>
                      </div>
                      <div className="flex justify-start gap-3">
                        <div className="w-[95px] sm:w-[130px] flex justify-end">
                        ...
                        <span className="text-left">
                          {t("hotelOwner.websiteFileFormatValue")}
                        </span>
                      </div>
                    </div>
                  </div>
...
export default HotelOwnerFormBasic;
